						...
						<div class="main-header-left">
							...
							<div class="hor-logo">
								<a class="main-logo" href="{{url('index')}}">
									<img src="{{Vite::asset('build/assets/img/brand/logo.png')}}" class="header-brand-img desktop-logo" alt="logo">
									<img src="{{Vite::asset('build/assets/img/brand/logo-light.png')}}" class="header-brand-img desktop-logo-dark" alt="logo">
								</a>
							</div>
						</div>
						<div class="main-header-center">
							<div class="responsive-logo">
								<a href="{{url('index')}}"><img src="{{Vite::asset('build/assets/img/brand/logo.png')}}" class="mobile-logo" alt="logo"></a>
								<a href="{{url('index')}}"><img src="{{Vite::asset('build/assets/img/brand/logo-light.png')}}" class="mobile-logo-dark" alt="logo"></a>
							</div>
									...
									<div class="d-flex order-lg-2 ms-auto">
										...
										<div class="dropdown main-header-notification flag-dropdown">
											<a class="nav-link icon text-center" data-bs-target="#country-selector" data-bs-toggle="modal">
												<img class="header-icons" alt="" src="{{Vite::asset('build/assets/img/flags/us_flag.jpg')}}">
											</a>
										</div><!-- country flag -->
												...
												<div class="main-notification-list">
													<div class="media new">
														<div class="main-img-user online">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/5.jpg')}}">
														</div>
													...
													<div class="media">
														<div class="main-img-user">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/2.jpg')}}">
														</div>
														<div class="media-body">
															<a href="{{url('notifications-list')}}">
													...
													<div class="media">
														<div class="main-img-user">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/7.jpg')}}">
														</div>
														<div class="media-body">
															<a href="{{url('notifications-list')}}">
													...
													<div class="media">
														<div class="main-img-user">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/9.jpg')}}">
														</div>
														<div class="media-body">
															<a href="{{url('notifications-list')}}">
													...
													<div class="media">
														<div class="main-img-user online">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/3.jpg')}}">
														</div>
														<div class="media-body">
															<a href="{{url('notifications-list')}}">
										...
										<div class="dropdown d-flex main-header-message">
											...
											<div class="dropdown-menu">
												...
												<div class="main-message-list">
													...
													<div class="media">
														<div class="main-img-user">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/11.jpg')}}">
														</div>
														<div class="media-body">
															<a href="{{url('chat')}}">
													...
													<div class="media">
														<div class="main-img-user">
															<img alt="avatar" src="{{Vite::asset('build/assets/img/users/4.jpg')}}">
														</div>
														<div class="media-body">
															<a href="{{url('chat')}}">
										...
										<div class="dropdown d-flex main-profile-menu">
											<a class="d-flex" href="javascript:void(0);">
												<span class="main-img-user">
													<img alt="avatar" src="{{Vite::asset('build/assets/img/users/6.jpg')}}">
												</span>
											</a>
											<div class="dropdown-menu">
												<div class="header-navheading">
